...
| 2026-09-06 | `f5417721d8019a9831126f4d843edfc4de87653d` | revalidación del receiver histórico frente al productor Dexcom G7 modificado autorizado por el propietario | [`contracts/modified-dexcom-g7-broadcast-observed-v1.md`](contracts/modified-dexcom-g7-broadcast-observed-v1.md); se confirmó forma de consumo y debilidad de autenticación, sin copiar receiver, rangos ni fallbacks |
