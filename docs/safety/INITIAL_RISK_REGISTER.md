...
| R-010 | Aceptar un broadcast G7 basándose solo en extras controlables | Seguridad | El puerto Android v1 no tiene rama de lectura disponible; exigir release reproducible, anclas aprobadas e identidad de emisor verificable, sin confiar en action, package extra, paquete instalado o permiso `dangerous` | LC-003 + tests del puerto + [investigación oficial/productor/dispositivo](../validation/dexcom-g7-android-local-reception-2026-09-06.md) + [transporte observado](../contracts/modified-dexcom-g7-broadcast-observed-v1.md); faltan release reproducible y tests Android de emisor/permiso | Parcial: productor local autorizado e identificado; autenticación y lectura disponible bloqueadas |
