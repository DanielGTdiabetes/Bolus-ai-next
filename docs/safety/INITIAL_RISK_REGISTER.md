...
| R-010 | Aceptar un broadcast G7 basándose solo en extras controlables | Seguridad | El puerto Android v1 no tiene rama de lectura disponible; el verificador preparatorio exige package/UID atribuidos por Android y ancla exacta de release (versión + firmantes), sin confiar en action, package extra, paquete instalado o permiso `dangerous`; en API 34+ el productor debe habilitar identity sharing o aportar un mecanismo autenticado alternativo | LC-003 + tests del puerto + [`DexcomSenderAuthenticatorTest`](../../android/app/src/test/java/org/bolusai/next/glucose/dexcom/DexcomSenderAuthenticatorTest.kt) + [contrato de autenticación](../contracts/android-dexcom-sender-authentication-v1.md) + [investigación oficial/productor/dispositivo](../validation/dexcom-g7-android-local-reception-2026-09-06.md); faltan release reproducible, anclas reales, opt-in de identidad y tests Android de emisor/permiso | Parcial: verificador fail-closed implementado; no está integrado, el envío observado no comparte identidad y la lectura disponible sigue bloqueada |
